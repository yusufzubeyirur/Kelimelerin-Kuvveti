...
export default function NavButtons({navButtonsProps}) {
  
	const { wordsDataArray, currentWord, setCurrentWord, position } = navButtonsProps

	function changeWord(currentIndex, direction,) {
		let nextIndex
